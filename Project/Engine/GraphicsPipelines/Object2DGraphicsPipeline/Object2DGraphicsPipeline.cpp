...
void Object2DGraphicsPipeline::CompileShaders() {
	...
	vertexShaderBlob_ = shaderCompiler_->CompileShader(L"EngineAssets/Shaders/Object2D/Object2D.VS.hlsl", L"vs_6_0");
	assert(vertexShaderBlob_ != nullptr);

	pixelShaderBlob_ = nullptr;
	pixelShaderBlob_ = shaderCompiler_->CompileShader(L"EngineAssets/Shaders/Object2D/Object2D.PS.hlsl", L"ps_6_0");
