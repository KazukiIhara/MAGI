...
/// <summary>
/// 3Dオブジェクトグループの描画パイプライン
/// </summary>
class Object3DGroupGraphicsPipeline:public BaseGraphicsPipeline {
public:
	Object3DGroupGraphicsPipeline(DXGI* dxgi, ShaderCompiler* shaderCompiler);
	~Object3DGroupGraphicsPipeline()override;
