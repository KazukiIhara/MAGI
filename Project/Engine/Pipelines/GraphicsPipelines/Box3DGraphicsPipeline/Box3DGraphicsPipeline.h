...
/// 3Dボックス描画用のパイプライン
/// </summary>
class Box3DGraphicsPipeline : public BaseGraphicsPipeline {
public:
	Box3DGraphicsPipeline(DXGI* dxgi, ShaderCompiler* shaderCompiler);
	~Box3DGraphicsPipeline()override = default;
